...
namespace ECDSA
{
    public class Secp256k1
    {
        ...
        public static BigInteger Param_n = Utility.ParseHex("FFFFFFFF FFFFFFFF FFFFFFFF FFFFFFFE BAAEDCE6 AF48A03B BFD25E8C D0364141");
        ...
        public static Sig? SignDigest(BigInteger digest, BigInteger privateKey, BigInteger? userNonce = null, bool lowS = true)
        {
            BigInteger k, r, s;
            var N = Param_n;
